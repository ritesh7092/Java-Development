...
class ContactBookTest {
    ...
    public void testSearchContactByPhone() {
        ...
        Contact contactReturned = contactBook.searchContactByPhone("184048");

        assertNotNull(contactReturned);
        assertEquals("184048", contactReturned.getPhoneNumber());
        assertEquals("Toni", contactReturned.getName());
